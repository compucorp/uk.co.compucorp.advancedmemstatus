 ...
 */
class CRM_Advancedmemstatus_Upgrader_Base {
  ...
  static public function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Advancedmemstatus_Upgrader(
   ...
   *
   * @code
   * CRM_Advancedmemstatus_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
